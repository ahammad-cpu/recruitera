...
function buildTabs(planByAcct: Map<string, string>): Array<{ key: TabKey; label: string; test: (a: Account) => boolean }> {
  ...
  return [
    ...
    { key: 'trial', label: 'Trial', test: (a) => !!a.has_trial && a.activation_status === 'Active' && !isDisqualified(a) },
    { key: 'expired', label: 'Expired', test: (a) => !!a.has_trial && a.activation_status === 'Expired' && !isDisqualified(a) },
